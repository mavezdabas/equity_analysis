...
namespace ExecutionTraderMainWindow.Helpers
{
    ...
    {
        internal static BlockModel ConvertBlockToBlockModel(DataAccessLayer.Block block)
        {
            if (block == null)
                return null;
        ...
        internal static BlockModel ConvertBlockToBlockModelWithoutOrders(DataAccessLayer.Block block)
        {
            if (block == null)
                return null;
            BlockModel newBlockModel = new BlockModel()
        ...
        internal static Block ConvertBlockModelToBlock(BlockModel blockModel)
        {
            ...
            return new Block
            {
                BlockID = Convert.ToInt32(blockModel.BlockId),
