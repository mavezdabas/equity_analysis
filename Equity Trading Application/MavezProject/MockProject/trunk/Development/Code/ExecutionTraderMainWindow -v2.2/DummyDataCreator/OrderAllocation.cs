...
namespace DummyDataCreator
{
    public partial class OrderAllocation
    {
        ...
        {
            if (previousValue != null && ReferenceEquals(previousValue.OrderAllocation, this))
            {
                previousValue.OrderAllocation = null;
            }
    
            if (Order != null)
            {
                Order.OrderAllocation = this;
                if (AllocationID != Order.OrderID)
                {
                    AllocationID = Order.OrderID;
                }
            }
        }
