...
-- --------------------------------------------------
-- Date Created: 04/03/2014 15:34:42
-- Generated from EDMX file: D:\Mock\trunk\Development\Code\PortfolioManager\DataAccessLayer\DataAccessLayer\ModelEquityTrading.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_Portfolio_Client]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Portfolio] DROP CONSTRAINT [FK_Portfolio_Client];
GO
...
GO
IF OBJECT_ID(N'[EquityTradingDBModelStoreContainer].[FK_SecurityConfigurationDetails_Securities]', 'F') IS NOT NULL
    ALTER TABLE [EquityTradingDBModelStoreContainer].[SecurityConfigurationDetails] DROP CONSTRAINT [FK_SecurityConfigurationDetails_Securities];
GO
...
IF OBJECT_ID(N'[dbo].[AllocationMethod]', 'U') IS NOT NULL
    DROP TABLE [dbo].[AllocationMethod];
GO
...
GO
IF OBJECT_ID(N'[dbo].[Portfolio]', 'U') IS NOT NULL
...
GO
IF OBJECT_ID(N'[EquityTradingDBModelStoreContainer].[SecurityConfigurationDetails]', 'U') IS NOT NULL
    DROP TABLE [EquityTradingDBModelStoreContainer].[SecurityConfigurationDetails];
GO
...
-- Creating primary key on [MaxPriceSpread], [MaxExecutionNumber], [MaxExecutionInterval], [FullyExecutedOrderProbability], [SecurityID] in table 'SecurityConfigurationDetails'
ALTER TABLE [dbo].[SecurityConfigurationDetails]
ADD CONSTRAINT [PK_SecurityConfigurationDetails]
    PRIMARY KEY CLUSTERED ([MaxPriceSpread], [MaxExecutionNumber], [MaxExecutionInterval], [FullyExecutedOrderProbability], [SecurityID] ASC);
GO
