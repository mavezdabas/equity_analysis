...
<html>
    ...
    <body>
    	<div class="header">
        	<a href="<?php echo $url_home; ?>"><img src="<?php echo $design; ?>/images/logo.jpg" alt="Forum" /></a>
	    </div>
...
<a href="<?php echo $url_home; ?>">Thanks</a></div>
<?php
		}
		else
		{
...
?>
		...
		<div class="foot">@mavez<br>@kapil<br>@abhinav<br></div>
	</body>
</html>